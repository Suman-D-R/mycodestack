...
export default function Home() {
  ...
  return (
    <>
      {!isRiveLoaded && (
        <div className='w-full h-svh flex items-center justify-center bg-black z-50 absolute top-0 left-0'>
      ...
      <div className='h-auto w-full '>
        ...
        <div className='w-full h-svh flex items-center justify-center relative'>
          ...
          <div className='flex flex-col max-w-7xl items-center justify-center gap-4 w-full h-full'>
            ...
            <div
              className={`text-sm lg:text-lg w-full px-6 ${
                isAnimationComplete ? 'fadeUp' : 'opacity-0'
              } text-center`}
            >
              <div>
                I build things for the web that look good, feel smooth, and just
                work. From clean UI layouts to tiny micro-animations that make
                you smile, I’m all about adding those little touches that make a
                big difference.
              </div>
        ...
        >
          ...
          <div className='relative flex flex-col  items-center justify-center gap-4 max-w-5xl text-xs lg:text-lg  font-normal text-white text-center'>
            <div className=''>
              ...
              is simple — make things just work, run fast, and feel smooth, with
            ...
            <div className=''>
              ...
              I’m all about learning, experimenting, and using creativity to
            ...
            <div className='w-full lg:h-[404px] h-auto flex flex-col gap-2 items-center justify-center'>
              ...
              <div className='text-xs lg:text-sm font-normal flex flex-col gap-2 text-center'>
                <div className='animate-on-scroll'>
                  ...
                  interactions. Using Next.js, Canvas, and Tailwind CSS, I built
                  high-performance web apps with optimized rendering, faster
                ...
                <div className='animate-on-scroll'>
                  ...
                  and Lottie, I enhanced user engagement and retention, and
                  worked closely with designers and product teams to deliver
            ...
            <div className='w-full lg:h-[404px] h-auto flex flex-col gap-2 items-center justify-center text-white lg:px-8 px-2'>
              ...
              <div className='text-xs lg:text-sm font-normal flex flex-col gap-2 text-center'>
                <div className='animate-on-scroll'>
                  ...
                  across consumer-facing and fintech platforms. Collaborating
                  with designers and product teams, I translated UI/UX designs
                  into pixel-perfect, high-performance interfaces while adhering
                  to fintech compliance standards. I also built reusable,
                  modular components to improve development efficiency and
                ...
                <div className='animate-on-scroll'>
                  ...
                  debugging, and performance optimization, I enhanced
                  application stability, responsiveness, and user satisfaction,
            ...
            <div className='w-full lg:h-[404px] h-auto flex flex-col gap-2 items-center justify-center text-white'>
              ...
              <div className='text-xs lg:text-sm font-normal flex flex-col gap-2 text-center'>
                <div className='animate-on-scroll'>
                  ...
                  the full development lifecycle, I handled UI/UX design,
                  backend API integration, testing, deployment, and maintenance
                  while ensuring timely delivery and smooth project execution. I
                  collaborated closely with clients and stakeholders, providing
                ...
                <div className='animate-on-scroll'>
                  ...
                  performance optimizations, responsive design, and
                  accessibility best practices, I delivered polished
                  applications that enhanced user engagement, functioned
